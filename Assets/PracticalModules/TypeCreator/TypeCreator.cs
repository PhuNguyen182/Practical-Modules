...
namespace PracticalModules.TypeCreator.Core
{
    /// <summary>
    ...
    {
        private readonly Func<T> compiledConstructor;
        ...
        public bool CanCreate => this.canCreate;
        ...
        public TypeCreator()
        {
            ...
            this.compiledConstructor = this.CompileConstructor();
            this.canCreate = this.compiledConstructor != null;
        ...
        public T Create()
        {
            ...
            return this.compiledConstructor();
        }
        ...
        public bool TryCreate(out T instance)
        {
            ...
            try
            {
                instance = this.compiledConstructor();
                return true;
            }
            catch
            {
