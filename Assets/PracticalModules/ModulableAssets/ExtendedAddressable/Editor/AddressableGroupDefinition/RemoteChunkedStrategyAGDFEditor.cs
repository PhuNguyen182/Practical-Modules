...
{
    [CustomEditor(typeof(RemoteChunkedStrategyAGDF))]
    public class RemoteChunkedStrategyAGDFEditor : OdinEditor
    {
        private string _folderPath;
        private RemoteChunkedStrategyAGDF _target;

        private void Awake()
        {
            _target = (RemoteChunkedStrategyAGDF)target;
